  ...
  return (
    ...
    >
      <div className="shadow position-relative p-3 pt-5 p-lg-5 ">
        ...
        ></h3>
        <p
          className={poemsData[currentPoemId].underTitle ? "poemUnderTitle" : "d-none"}
          dangerouslySetInnerHTML={{ __html: poemsData[currentPoemId].underTitle }}
        ></p>
        <p
          className="poemFontSizing italics pt-1 pt-lg-3 pb-1 pb-lg-4 "
          dangerouslySetInnerHTML={{ __html: poemsData[currentPoemId].authors }}
        ></p>
        <p
          className="poemFontSizing poemContents lh-base fw-bolder"
          dangerouslySetInnerHTML={{ __html: poemsData[currentPoemId].contents }}
        ></p>
      </div>
    </div>
    </>
